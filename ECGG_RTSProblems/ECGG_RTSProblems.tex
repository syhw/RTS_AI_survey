...
significant  amount of  success,  and,  as we  will  discuss later  in
Section~\ref{sec:bot}, have  also been  used in  many academic  RTS AI
...
units.  \v{C}ertick\'{y} solved  this constraint  satisfaction problem
...
complexity. Also,  abstractions, or  simplifications about the  set of
possible actions to execute in a given game state need to be used.
...
Holistic approaches  to address  RTS AI attempt  to address  the whole
