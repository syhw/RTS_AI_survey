...
{\color{blue} AIIDE 2013: Skynet and AIUR learning, BBQ opponent strategy
  learning,  UAB  branch-and-bound  for   build  order  during  games,
  SparCraft for combat simulations}
