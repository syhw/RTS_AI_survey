...
environment, simpler dynamics in a  finite and smaller
world, although still complex enough  to bring very difficult and interesting
...
tackling  these problems  on  RTS  games can  thus  benefit broader  AI
domains, but  also have concrete  and direct applications in  the ever growing
...
the art in RTS AI, and with a particular emphasis on the work done in StarCraft, is organized as follows: Section~\ref{sec:rts}
...
compiles open questions in RTS game AI.
