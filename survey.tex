...
Most commercial games avoid gathering this information by using perfect information all the time (cheating). Sometimes they simulate some scouting tasks as Bob Fitch described in his AIIDE 2011 keynote for the WarCraft game series and StarCraft: Broodwar. {\color{blue}XXX (perhaps move it above, to the start of subsection}
