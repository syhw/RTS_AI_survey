...
or withdrawing  units from battle.  Strategy also copes  with temporal
reasoning, mainly  with planning problems:  when researching upgrades,
when constructing wished buildings,  when switching strategy if needed,
etc.
